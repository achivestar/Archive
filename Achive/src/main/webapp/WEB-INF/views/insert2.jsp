            ...
            <div style="height:140px"> </div>
                                   ...
                                   <div class="container">
									    ...
									    <button id="btn-upload" type="button" style="background-color:steelblue;color:#fff;width:200px;height:50px;border: 1px solid #ddd; outline: none;cursor:pointer">이미지 파일 추가</button>
										 <input id="input_file" accept="image/*" multiple="multiple"  type="file" style="display:none;"><br>
										 	<span style="font-size:14px; color: red;">* 이미지 파일은 한번에 최대 10개까지 등록이 가능합니다.</span><br>
