            ...
            <div class="cd-slider-nav">
                <nav class="navbar">
                    <div class="tm-navbar-bg">
                        ...
                        <a class="navbar-brand text-uppercase" href="#"><i class="fa fa-picture-o tm-brand-icon"></i>Archive Gallery</a>
                  ...
                  <div class="container">
						<table class="table">
							<thead class=" text-primary">
								<tr>
									<td width="15%" class="text-center">No</td>
									<td width="40%" class="text-center">앨범이름</td>
									<td width="20%" class="text-center">촬영일자</td>
									<td width="15%" class="text-center">Manage</td>
								</tr>
							</thead>
							<tbody>
							  ...
							  <c:set var="TextValue" value="${list.sdate}"/>
								<tr  class="text-center">
									...
									<td><%-- <a href="${pageContext.request.contextPath}/imgModify?idx=${list.idx}" class="btn btn-warning">수정</a>&nbsp; --%>
